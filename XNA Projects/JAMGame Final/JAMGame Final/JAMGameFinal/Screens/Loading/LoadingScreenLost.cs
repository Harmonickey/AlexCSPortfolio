...
{
    class LoadingScreenLost : GameScreen
    {
        bool loadingIsSlow;
        ...
        private LoadingScreenLost(ScreenManager screenManager, bool loadingIsSlow,
                              GameScreen[] screensToLoad)
        {
                                ...
                                params GameScreen[] screensToLoad)
        {
            ...
            LoadingScreenLost loadingScreen = new LoadingScreenLost(screenManager,
                                                            loadingIsSlow,
                                                            screensToLoad);
