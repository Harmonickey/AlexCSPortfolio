...
namespace JAMGameFinal
{
    ...
    class Level2 : JAMZombieGameEngine
    {
        float scale;
        float[] sen = new float[4];

        //the health bar and background texture
        Texture2D healthBar, gameBackgroundTexture;
        ...
        public Level2(Character p1, Character p2, Character p3, Character p4, Handicap h1, Handicap h2, Handicap h3, Handicap h4, int numberPlaying,
        ...
        void SpawnZombies(Vector2 scrollOffset)
        {
            ...
            foreach (Zombie zombie in zombies)
            {
                if ((random.NextDouble() < ZombieSpawnProbability) && (NumberOfZombies < MaxZombies) && !zombie.alive)
                {
                    ...
                    |                           |
                    |                           |
  Third Spawn Point |                           | Fourth Spawn Point
                    |                           |
                    |                           |
                    |                           |
                    -----------------------------
                    ...
                    */
                    ...
                    {
                        zombie.position = new Vector2(x, -zombie.sprite.Height);
                    ...
                    {
                        zombie.position = new Vector2(x, 2160 + zombie.sprite.Height);
                        zombie.alive = true;
                        NumberOfZombies++;
                    ...
                    {
                        zombie.position = new Vector2(-zombie.sprite.Width, y);
                        zombie.alive = true;
                        NumberOfZombies++;
                    ...
                    {
                        zombie.position = new Vector2(3840 + zombie.sprite.Width, y);
                        zombie.alive = true;
                        NumberOfZombies++;
