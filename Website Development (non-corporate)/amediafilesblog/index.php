...
<html>
	<head>
		<title>A MediaPhile's Blog | Reviews of Movies, T.V.Shows, Music | Updated Daily</title>
        	...
        	<div id="middle"> 
				...
				<?php
					function getRows($limit) 
					{
						...
						//create an entry
						echo '<tr class="entry-container">';	
							echo '<td>';
							echo '<div class="entry" style="position: relative;">';
								...
								echo '<div class="showmorepost" onclick="showMorePost(this)"> Show More </div>';
						...
						if ($counter > $limit) 
						{
								echo '<div class="showmore" onclick="showMore()"> Show More </div>';
