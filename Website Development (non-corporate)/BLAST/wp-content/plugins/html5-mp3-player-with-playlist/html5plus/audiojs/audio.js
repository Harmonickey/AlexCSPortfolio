...
(function(audiojs, audiojsInstance, container) {
  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      css: '\
        ...
        .audiojs .scrubber { position: relative; float: left; width: 322px; background: #5a5a5a; height: 14px; margin: 10px; border-top: 1px solid #3f3f3f; border-left: 0px; border-bottom: 0px; overflow: hidden; } \
  ...
  container[audiojsInstance].prototype = {
    ...
    trackEnded: function(e) { 
      ...
      if (!this.settings.loop){ this.pause.apply(this);}else{
