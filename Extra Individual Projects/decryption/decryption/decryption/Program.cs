...
namespace decryption
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                loopedFindFile = 1;
                Console.Write("Enter the name of the text file " + Environment.NewLine + "on your desktop to be decrypted: ");
                ...
                if (File.Exists(encryptionFile))
                {
                    ...
                    Console.Write("Enter k shift value: ");  //11
                    int k = int.Parse(Console.ReadLine());
                    Console.WriteLine("Enter modulus value: ");  //93
